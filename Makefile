...
CXX_COMPILER=mpic++
CXX_FLAGS= -fopenmp -std=c++17 -DNUM_THREADS=$(NUM_THREADS) -DORDER_METHOD=\"$(ORDER_METHOD)\" -DN_ROOTS=$(N_ROOTS)
...
gpsl:
	...
	$(CXX_COMPILER) -c $(CXX_SOURCE_FILES) $(CXX_FLAGS) $(CXX_MODE_FLAGS) $(GPSL_FLAGS)
	$(CXX_COMPILER) $(CXX_FLAGS) $(CXX_MODE_FLAGS) $(GPSL_FLAGS) -L$(CUDA_LIB_PATH) *.o -lcudart -o gpsl
	rm *.o
