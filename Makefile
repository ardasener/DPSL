...
gpu-debug:
	nvcc src/gpsl.cu -o gpsl -O0 -g -G -std=c++17 -Xcompiler -fopenmp -Xcompiler -L./libs -Xcompiler -l:libmetis.so -Xcompiler -l:libkahypar.so -Xcompiler -no-pie -arch=sm_60
gpu-profile:
	nvcc src/gpsl.cu -o gpsl -O3 -g -G -std=c++17 -Xcompiler -fopenmp -Xcompiler -L./libs -Xcompiler -l:libmetis.so -Xcompiler -l:libkahypar.so -Xcompiler -no-pie -arch=sm_60
