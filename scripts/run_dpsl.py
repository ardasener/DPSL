...
# Usage: <script> <dpsl_exe> <np> <partitioner_exe>
...
def get_stats(out):
    ...
    return time, merge, max_mem, tot_mem, part
...
for graph in graphs:
    ...
    for i in range(0,n_runs):
        try:
            ...
            print(out)
            time, merge, max_mem, tot_mem, part = get_stats(out)
            part_times.append(part)
            times.append(time)
